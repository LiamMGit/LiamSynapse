...
namespace SRT.Views
{
    ...
    [ViewDefinition("SRT.Resources.Mods.bsml")]
    public class EventModsViewController : BSMLAutomaticViewController
    {
        ...
        private static string ContentBSML
        {
            get
            {
                ...
                using StreamReader reader = new(typeof(EventModsViewController).Assembly.GetManifestResourceStream("SRT.Resources.ModsContent.bsml")
