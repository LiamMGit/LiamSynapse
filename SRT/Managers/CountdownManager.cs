    ...
    internal class CountdownManager : ITickable, IInitializable
    {
        private static readonly string _folder =
            Directory.CreateDirectory(
                ...
                $"{Path.DirectorySeparatorChar}SRT{Path.DirectorySeparatorChar}Countdown").FullName;
        ...
        private CountdownManager(NetworkManager networkManager, AudioClipAsyncLoader audioClipAsyncLoader)
        {
        ...
        public void Tick()
        {
            TimeSpan diff = _startTime - DateTime.UtcNow;
        ...
        private async Task LoadAudio(AudioClipAsyncLoader audioClipAsyncLoader)
        {
            try
            {
                ...
                const string prefix = "SRT.Resources.Countdown.";
                const int count = 5;
