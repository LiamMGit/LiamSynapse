...
{
    public sealed class DownloadingManager : IDisposable
    {
        ...
        public async Task<bool> Download(string url, string unzipPath, Action<float>? progress, Action? unzipping, Action<float>? unzipProgress, Action<string>? error, CancellationToken token)
        {
            try
            {
